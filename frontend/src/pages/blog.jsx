  ...
  return (
    <section className="mx-auto max-w-6xl px-6 py-16">
          ...
          <div key={idx} className="group flex flex-col rounded-[32px] border border-brown/10 bg-white p-8 shadow-soft transition hover:shadow-md">
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-xs">
                <span className="bg-white px-2 text-brown/40">read the full story on our blog</span>
              </div>
            </div>
      ...
      <div className="mt-10 rounded-[32px] border border-brown/10 bg-white p-10 text-center shadow-soft">
        <h3 className="text-xl font-semibold text-deep-brown">Want to share your story?</h3>
        ...
        <div className="mt-6 flex flex-col gap-4 sm:flex-row sm:justify-center">
          <a
            ...
            className="inline-flex rounded-full bg-gold px-6 py-3 text-sm font-semibold text-deep-brown transition hover:bg-[#b8922e]"
          >
            Share Your Story →
          </a>
          <a
            href="/blog/submit"
            className="inline-flex rounded-full border border-brown/20 bg-white px-6 py-3 text-sm font-semibold text-deep-brown transition hover:bg-brown/5"
          >
            Read More on Our Blog →
          </a>
        </div>
        
        <p className="mt-6 text-xs text-brown/40">
